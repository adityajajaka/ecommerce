				...
				<td data-th="Product">
					<div class="row">
						<div class="col-sm-3 hidden-xs">
							...
							<img src="{{ url('storage/img/'.$product['image_url']) }}" width="100" height="100" class="img-responsive">
						</div>
						<div class="col-sm-9">
		...
		<tfoot>
			...
			<tr>
				<td>
					...
					<a href="{{ route('admin.orders.create') }}" class="btn btn-primary"><i class="fa fa-angle-left"></i>Lanjut Ke Pembayaran</a>
				</td>
